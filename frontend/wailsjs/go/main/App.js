...
export function CancelHistoricalImport() {
  return window['go']['main']['App']['CancelHistoricalImport']();
}
...
export function DiscoverHistoricalLogs() {
  return window['go']['main']['App']['DiscoverHistoricalLogs']();
}
...
export function GetHistoricalImportProgress() {
  return window['go']['main']['App']['GetHistoricalImportProgress']();
}
...
export function StartHistoricalImport(arg1) {
  return window['go']['main']['App']['StartHistoricalImport'](arg1);
}
