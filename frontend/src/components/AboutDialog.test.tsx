...
describe('AboutDialog', () => {
  ...
  describe('Links Section', () => {
    ...
    it('should render GitHub repository link', () => {
      ...
      expect(link).toHaveAttribute('href', 'https://github.com/RdHamilton/hollowmark');
    ...
    it('should render issue tracker link', () => {
      ...
      expect(link).toHaveAttribute('href', 'https://github.com/RdHamilton/hollowmark/issues');
      expect(link).toHaveAttribute('target', '_blank');
      expect(link).toHaveAttribute('rel', 'noopener noreferrer');
    });
    ...
    it('should render documentation link', () => {
      ...
      expect(link).toHaveAttribute('href', 'https://github.com/RdHamilton/hollowmark/wiki');
      expect(link).toHaveAttribute('target', '_blank');
      expect(link).toHaveAttribute('rel', 'noopener noreferrer');
    });
