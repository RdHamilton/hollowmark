...
# `go env -w GOPRIVATE=github.com/RdHamilton/vault-mtg,github.com/RdHamilton/hollowmark` once on their machine.
# See ADR-023 Addendum II ("Immutability Principle") for the root cause.
export GOPRIVATE=github.com/RdHamilton/vault-mtg,github.com/RdHamilton/hollowmark
