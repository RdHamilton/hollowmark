...
### 1. Update docs/architecture/adr/
**When to update**: When making or discussing any architectural decision

**What to update**:
- Add a new ADR file at `docs/architecture/adr/NNNN-short-title.md` (zero-padded 4-digit number, next sequential)
- Use the template in `docs/architecture/adr/README.md`
- Update the ADR index in `docs/architecture/adr/README.md`
- Change status from "Proposed" to "Accepted" when the decision is finalized
...
### 2. Update docs/engineering/claude-code-guide.md (this file)
...
1. "Did we make an architectural decision?" → Add a new ADR under `docs/architecture/adr/` and update the index in `docs/architecture/adr/README.md`
2. "Did the architecture/workflow change?" → Update `docs/engineering/claude-code-guide.md`
3. "Did user-facing features change?" → Update `README.md`
4. "Did we add new documentation?" → Update `docs/README.md` index
...
- See [docs/engineering/reference/daemon-api.md](reference/daemon-api.md) for complete event reference
...
**For complete architecture details, see [docs/architecture/overview.md](../architecture/overview.md)**
...
**[docs/engineering/reference/mtga-log-research.md](reference/mtga-log-research.md)**
...
For complete architectural details and rationale, see the ADR index in `docs/architecture/adr/README.md`.
