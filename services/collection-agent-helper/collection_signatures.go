...
var knownSignatureVersions = map[string]string{
	...
	"20260611-001": "MTGA patch 2026.59.30; hollowmark-tickets#1285 — adaptive region selection (densest valid int→int region via scanner.SelectCollection), minEntries/maxFillPct thresholds removed, sanity band [100, 100000] with loud COLLECTION_SCAN_DRIFT on violation; stride=16 unchanged; 19263 entries from region 0x376940000",
}
