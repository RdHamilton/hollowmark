...
//
// Adapted from the original (PR #3181): Deps field names are unchanged; the
// stub types (stubPostHog, stubClerk, stubMailchimp) remain present in this
// file.  Reporter is intentionally omitted (nil is safe per Deps doc comment).
